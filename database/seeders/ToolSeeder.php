    ...
    public function run(): void
    {
        $tools = [
            ...
            [
                ...
                'last_calibration_at' => Carbon::now()->subMonths(2),
                'imei' => 'MIT-CD6-001',
            ...
            [
                ...
                'tool_model' => 'Mitutoyo CD-6',
                'tool_type' => ToolType::MECHANICAL,
                'last_calibration_at' => Carbon::now()->subMonths(3),
                'imei' => 'MIT-CD6-002',
                'status' => ToolStatus::ACTIVE,
            ],
            [
                ...
                'tool_model' => 'Mitutoyo CD-6',
                'tool_type' => ToolType::MECHANICAL,
                'last_calibration_at' => Carbon::now()->subMonths(1),
                'imei' => 'MIT-CD6-003',
            ...
            [
                ...
                'last_calibration_at' => Carbon::now()->subMonths(4),
                'imei' => 'KEY-LK5001-A',
                'status' => ToolStatus::ACTIVE,
            ],
            [
            ...
            [
                ...
                'tool_type' => ToolType::MECHANICAL,
                'last_calibration_at' => Carbon::now()->subMonths(5),
                'imei' => 'MAH-40EWR-001',
                'status' => ToolStatus::ACTIVE,
            ],
            [
            ...
            [
                ...
                'tool_type' => ToolType::MECHANICAL,
                'last_calibration_at' => Carbon::now()->subMonth(),
                'imei' => 'MIT-293340-001',
                'status' => ToolStatus::ACTIVE,
            ],
